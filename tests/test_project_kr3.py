...
@pytest.mark.parametrize("data, result", [("Maestro 1111111111111111", "Maestro 1111 11** **** 1111"),
...
def test_format_account_number(data, result):
    assert project_kr3.utils.format_account_number(data) == result
